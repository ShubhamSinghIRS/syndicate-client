...
export default function FaqSection() {
  ...
  return (
    <div className="w-full bg-[#FAF7F2] dark:bg-layout-background py-16 md:py-20">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mx-auto max-w-1xl mt-10 rounded-2xl border border-[#ECE8DF] dark:border-gray-800 bg-white dark:bg-main-background px-5 sm:px-8 py-3 shadow-[0_2px_8px_rgba(0,0,0,0.02)]">
